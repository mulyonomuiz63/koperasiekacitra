                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex my-4">
                                <span class="badge badge-light-<?= $pegawai['status'] == 'aktif' ? 'success' : 'warning' ?> fs-6">
                        ...
                        if ($hasUploaded && $pembayaranStatus === 'approved') $progress = 100;
                        ?>
                                ...
                                <form action="<?= base_url('sw-anggota/lengkapi-data') ?>" method="post">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nip" class="form-control" 
                                                value="<?= old('nip', $pegawai['nip'] ?? 'NIP-'.date('Ymd').rand(1000,9999)) ?>" readonly>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="tanggal_masuk" class="form-control" value="<?= old('tanggal_masuk', $pegawai['tanggal_masuk'] ?? '') ?>">
                                        </div>
                                    </div>
